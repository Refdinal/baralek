    ...
    <div className="app-container">
      ...
      showDashboard ? (
        ...
        <>
          ...
          {isUnlocked && <MusicPlayer isPlaying={isPlaying} togglePlay={togglePlay} />}
          ...
          <div className={`main-content ${isUnlocked ? "active" : ""}`}>
            ...
            <main>
              ...
              <Gallery />
              <Gift />
              <RSVP wishes={wishes} onSubmitRSVP={onSubmitRSVP} loadingWishes={loadingWishes} />
            </main>
            ...
            <footer className="wedding-footer">
              <div className="footer-content">
                ...
                <p className="footer-sub">
                  Merupakan kehormatan dan kebahagiaan bagi kami bila Bapak/Ibu/Saudara/i berkenan hadir dan memberikan
                  doa restu bagi kami.
                </p>
          ...
          <style jsx="true">{`
            ...
            .hero-header {
              height: 100vh;
              background:
                linear-gradient(rgba(44, 62, 53, 0.4), rgba(44, 62, 53, 0.6)),
